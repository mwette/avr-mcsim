...
\begin{tikzpicture}[%
  ...
  \node (WD3b) [right=2.5cm of WS2, diamond, draw] {};
  ...
  % new:
  \node (FLD) at ($(S1)+(8.0cm,0)$) [rectangle, rounded corners=15pt, draw,
    minimum height=0.4in, minimum width=0.8in, thick]
        {\parbox[t]{0.6in}{\centering{FAILED}}};
  % ^new
  \draw[->] (FLD.west) -- node[above] {50:reset/reset} (S1.east);

  \draw[->] (S1.165) --
  node[below,pos=0.3,sloped] {11:\textbf{write}/addr} (WS2);

  \draw[->] (WS2.east) -- node[above] {12:intr[WIF]} (WD3b.west);
  ...
  \draw[->,rounded corners] (t13S) -- (t13a) --
            node[above,sloped] {13:[failure]} (t13b) -- (t13c) -- (t13E);

  %\coordinate (t24S) at (WD3a.north);
  \coordinate (t24S) at (WD3b.north);
  \coordinate (t24E) at (FLD.5);
  ...
  \node (RS2) [left=2.5cm of RD3b, rounded corners=15pt,
    draw, minimum height=0.4in, minimum width=0.75in, thick]
  ...
  \draw[->] (RS2.east) -- node[below,pos=0.5] {32:intr[WIF]} (RD3b.west);
  ...
  \draw[->] (RD4.north) -- node[right,pos=0.5] {37:[nr=0]/stop} (S1.south);

  \coordinate (t35S) at (RD3c.south);
  \coordinate (t35E) at (FLD.345);
  ...
  \coordinate (t44S) at (RD3b.south);
  \coordinate (t44E) at (FLD.355);
  ...
  \coordinate (B8a0) at (FLD.south -| A8a0);
  \draw[->] (A8a0) -- node[left] {41:[failure]} (B8a0);

  \coordinate (t43S) at (RD6b.north);
  \coordinate (t43E) at (FLD.south -| t43S);
