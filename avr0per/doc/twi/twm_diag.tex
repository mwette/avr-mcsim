...
\begin{tikzpicture}[text=black,node font=\small,>=stealth]
  ...
  \node (WS5) [right=2.5cm of WD4, rectangle, rounded corners=15pt, draw,
    minimum height=0.4in, minimum width=0.7in, thick]
        {\parbox[t]{0.3in}{\centering{DATA SEND}}};
  \node (WD6a) [right=2.5cm of WS5, diamond, draw ] {};
  %\node (WD6b) [right=1.0cm of WD6a, diamond, draw ] {};
  ...
  %
  %\node (S0) [right=1.0cm of S1, circle, draw, radius=8pt, fill] {};
  \node (S0) [left=1.75cm of S1, circle, draw, radius=8pt, fill] {};
  \draw[->] (S0) -- (S1);

  % new:
  \node (FAIL) at ($(S1)+(7.5cm,0)$) [rectangle, rounded corners=15pt, draw,
    minimum height=0.4in, minimum width=0.8in, thick]
  ...
  \node (RS2) [left=2.5cm of RD3a, rounded corners=15pt,
    draw, minimum height=0.4in, minimum width=0.75in, thick]
        {\parbox[c]{0.7in}{\centering{ADDR\  SEND/r}}};
  \node (RS5) [right=2.5cm of RD4, rectangle, rounded corners=15pt, draw,
    minimum height=0.4in, minimum width=0.7in, thick]
        {\parbox[t]{0.3in}{\centering{DATA RECV}}};
  ...
  \draw[->,rounded corners] (t44S) -- (d44x45) -- (t44a) --
